...
For time-of-day variation, use `--schedule conf/schedule/ecommerce.json`. See the [schedule documentation](../docs/schedules.md) for how schedules interact with `-m` and the ceiling.
