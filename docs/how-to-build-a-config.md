...
| `-w` too high | No visible effect on throughput, confusing results | Run `tools/bench_config.py` to find the empirical ceiling and document it in the preset doc |
